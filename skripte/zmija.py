...
class ZutaZmija:
    def __init__(self, pozicija, sirina, visina):
        ...
        self.glava = pygame.image.load("assets/slike/zuta_glava_zmije.png").convert_alpha()
        self.tijelo = pygame.image.load("assets/slike/zuta_slika_tijela.png").convert_alpha()
        self.rep = pygame.image.load("assets/slike/zuta_slika_repa.png").convert_alpha()
